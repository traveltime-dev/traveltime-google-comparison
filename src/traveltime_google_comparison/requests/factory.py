...
from traveltime_google_comparison.requests.openroutes_handler import OpenRoutesRequestHandler
...
def initialize_request_handlers(
    ...
    return {
        ...
        OPENROUTES_API: OpenRoutesRequestHandler(openroutes_api_key, openroutes_max_rpm),
